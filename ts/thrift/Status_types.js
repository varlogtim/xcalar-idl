...
StatusT = {
  ...
  'StatusIMDTableAlreadyLocked' : 650,
  'StatusSelfSelectRequired' : 651,
  'StatusSessionNameMissing' : 652,
  'StatusXpuConnAborted' : 653,
  'StatusPTUpdatePermDenied' : 654,
  'StatusPTCoalescePermDenied' : 655,
  'StatusPTOwnerNodeMismatch' : 656,
  'StatusNsRefToObjectDenied' : 657,
  'StatusChecksumNotFound' : 658,
  'StatusChecksumMismatch' : 659,
  'StatusRuntimeSetParamInvalid' : 660,
  'StatusRuntimeSetParamNotSupported' : 661,
  'StatusPublishTableSnapshotInProgress' : 662,
  'StatusUDFOwnerNodeMismatch' : 663,
  'StatusUDFSourceMismatch' : 664,
  'StatusUDFUpdateFailed' : 665,
  'StatusUDFBadPath' : 666,
  'StatusDsMetaDataNotFound' : 667,
  'StatusDatasetAlreadyUnloaded' : 668,
  'StatusUdfModuleFullNameRequired' : 669,
  'StatusCgroupsDisabled' : 670,
  'StatusCgroupAppInProgress' : 671,
  'StatusJsonSessSerializeError' : 672,
  'StatusSessMdataInconsistent' : 673,
  'StatusRuntimeChangeInProgress' : 674,
  'StatusSelectLimitReached' : 675,
  'StatusLegacyTargetNotFound' : 676,
  'StatusDfpError' : 677,
  'StatusCgroupInProgress' : 678,
  'StatusConfigChangeInProgress' : 679,
  'StatusKvInvalidKey' : 680,
  'StatusKvInvalidValue' : 681,
  'StatusInvTableName' : 682,
  'StatusExistsTableName' : 683,
  'StatusTableNameNotFound' : 684,
  'StatusComplexTypeNotSupported' : 685,
  'StatusParquetParserError' : 686,
  'StatusUnSupportedDecimalType' : 687,
  'StatusUnSupportedLogicalType' : 688,
...
StatusTStr = {
  ...
  639 : 'UDFs are not supported as part of filter condition in cross joins',
  ...
  654 : 'Publish table permission denied, since update is being attempted by non-owner Session',
  655 : 'Publish table permission denied, since coalesce is being attempted by non-owner Session',
  656 : 'Publish table owner node does not match the expected node',
  657 : 'Denied reference to Namespace object',
  658 : 'Checksum not found',
  659 : 'Checksum mismatch',
  660 : 'Invalid parameter for setting Runtime configuration',
  661 : 'Setting Runtime configuration not supported',
  662 : 'Publish table Snapshot is already in progress',
  663 : 'UDF API invoked on non-owner node',
  664 : 'UDF source has unexpected contents',
  665 : 'UDF update failure during persistent write',
  666 : 'UDF path not recognized',
  667 : 'Dataset metadata doesn\'t exist',
  668 : 'Dataset is already unloaded',
  669 : 'UDF module name must be full path name',
  670 : 'Cgroups APIs have been disabled',
  671 : 'Cgroups App already in progress',
  672 : 'Error in JSON during session serialization',
  673 : 'Possible inconsistency in session metadata',
  674 : 'Setting Runtime configuration already in progress',
  675 : 'Limit for select number of rows reached',
  676 : 'Legacy target is not found',
  677 : 'Decimal floating point (DFP/Numeric) error',
  678 : 'Cgroup App already in progress',
  679 : 'Configuration change already in progress',
  680 : 'Invalid KvStore key',
  681 : 'Invalid KvStore value',
  682 : 'Invalid table name',
  683 : 'Table name already exists',
  684 : 'Table name not found',
  685 : 'Complex types in Parquet not supported',
  686 : 'Error parsing parquet file',
  687 : 'Unsupported Decimal type in Parquet',
  688 : 'Unsupported Logical type in Parquet Byte Array',
...
StatusTFromStr = {
  ...
  'UDF function name exceeds allowed length' : 333,
  'UDF function has too many parameters' : 334,
  ...
  'UDFs are not supported as part of filter condition in cross joins' : 639,
  ...
  'Publish table permission denied, since update is being attempted by non-owner Session' : 654,
  'Publish table permission denied, since coalesce is being attempted by non-owner Session' : 655,
  'Publish table owner node does not match the expected node' : 656,
  'Denied reference to Namespace object' : 657,
  'Checksum not found' : 658,
  'Checksum mismatch' : 659,
  'Invalid parameter for setting Runtime configuration' : 660,
  'Setting Runtime configuration not supported' : 661,
  'Publish table Snapshot is already in progress' : 662,
  'UDF API invoked on non-owner node' : 663,
  'UDF source has unexpected contents' : 664,
  'UDF update failure during persistent write' : 665,
  'UDF path not recognized' : 666,
  'Dataset metadata doesn\'t exist' : 667,
  'Dataset is already unloaded' : 668,
  'UDF module name must be full path name' : 669,
  'Cgroups APIs have been disabled' : 670,
  'Cgroups App already in progress' : 671,
  'Error in JSON during session serialization' : 672,
  'Possible inconsistency in session metadata' : 673,
  'Setting Runtime configuration already in progress' : 674,
  'Limit for select number of rows reached' : 675,
  'Legacy target is not found' : 676,
  'Decimal floating point (DFP/Numeric) error' : 677,
  'Cgroup App already in progress' : 678,
  'Configuration change already in progress' : 679,
  'Invalid KvStore key' : 680,
  'Invalid KvStore value' : 681,
  'Invalid table name' : 682,
  'Table name already exists' : 683,
  'Table name not found' : 684,
  'Complex types in Parquet not supported' : 685,
  'Error parsing parquet file' : 686,
  'Unsupported Decimal type in Parquet' : 687,
  'Unsupported Logical type in Parquet Byte Array' : 688,
