...
StatusT = {
  ...
  'StatusConfigChangeInProgress' : 678,
  'StatusKvInvalidKey' : 679,
  'StatusKvInvalidValue' : 680,
  'StatusInvTableName' : 681,
...
StatusTStr = {
  ...
  662 : 'UDF API invoked on non-owner node',
  663 : 'UDF source has unexpected contents',
  664 : 'UDF update failure during persistent write',
  665 : 'UDF path not recognized',
  666 : 'Dataset metadata doesn\'t exist',
  667 : 'Dataset is already unloaded',
  668 : 'UDF module name must be full path name',
  ...
  678 : 'Configuration change already in progress',
  679 : 'Invalid KvStore key',
  680 : 'Invalid KvStore value',
  681 : 'Invalid table name',
...
StatusTFromStr = {
  ...
  'UDF API invoked on non-owner node' : 662,
  'UDF source has unexpected contents' : 663,
  'UDF update failure during persistent write' : 664,
  'UDF path not recognized' : 665,
  'Dataset metadata doesn\'t exist' : 666,
  'Dataset is already unloaded' : 667,
  'UDF module name must be full path name' : 668,
  ...
  'Configuration change already in progress' : 678,
  'Invalid KvStore key' : 679,
  'Invalid KvStore value' : 680,
  'Invalid table name' : 681,
