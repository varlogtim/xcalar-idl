...
StatusTFromStr = {
  ...
  'Session user already deleted' : 567,
  'Session user does not exist' : 568,
  'Insufficient privilege to shutdown cluster' : 569,
  'Nothing available to serialize' : 570,
  'App with the given name already exists' : 571,
  'App specified was not found' : 572,
  'App currently in use' : 573,
  'Invalid stream context received' : 574,
  'Invalid number of bytes sent in payload' : 575,
  'Encountered partial failure in stats stream, cleaning up' : 576,
  'Log level is too large' : 577,
  'Client performed a handshake we didn\'t understand' : 578,
  'Query\'s metadata is on another node. Please go to that node' : 579,
  'App instance start error' : 580,
  'Timed out waiting for api' : 581,
  'IP address is too long' : 582,
  'Support bundle was created but not sent to Xcalar' : 583,
  'Encountered invalid stream protocol, cleaning up' : 584,
  'Encountered partial failure in blob stream, cleaning up' : 585,
  'Encountered unknown format in /proc/meminfo' : 586,
  'API received has invalid signature' : 587,
  'API received has invalid length' : 588,
  'LMDB Key/Value store error' : 589,
  'No buffers to receive on destination XPU' : 590,
  'Invalid ordering for Join' : 591,
  'Dataset is already locked' : 592,
  'XCE node alive, reap timed out' : 593,
  'Attempt to buffer logs failed' : 594,
  'Failure to unbuffer logs is fatal' : 595,
  'Failure in updating periodic log flushing' : 596,
  'The specified log level is not valid' : 597,
