window.SqlTestSuite = (function($, SqlTestSuite) {
    ...
    var sqlTestCases = {
        ...
        "groupingSets": "select n_regionkey, n_nationkey, max(n_name) from nation group by n_regionkey, n_nationkey grouping sets(n_regionkey, ()) order by n_regionkey, n_nationkey",
    ...
    var sqlTestAnswers = {
        ...
        "cube": {"row1": ["FNF", 0, "ALGERIA"],
                 ...
                 "numOfRows": "56"},
        "groupingSets": {"row0": ["FNF", "FNF", "VIETNAM"],
                         "row4": [3, "FNF", "UNITED KINGDOM"],
                         "numOfRows": "6"},
