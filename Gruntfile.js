...
//                    includePath: BLDROOT + htmlMapping.src,
    ...
    */
    grunt.task.registerTask(INIT, "Run 'npm install' in cwd; copy in modified version of watch plugin", function() {
        ...
        */
        executePatchFrom = 'node_modules/grunt-contrib-watch/tasks/lib';
        var cmdsets = [
            [SRCROOT,
                [
            ...
            ['services/expServer', // the node_modules generated by this, needs to get rsynced over to bld dir, for expServer to work
                [
                'npm install',
                ],
            ],
        ...
        var cmdset, executefrom, cmdlist, cmd;
        for ( cmdset of cmdsets ) {
            executefrom = cmdset[0];
...
//                    srclist.push(dependencyRelPath + "**/*");
    ...
    */
    ...
    grunt.task.registerTask(TYPESCRIPT, function() {
        ...
        grunt.log.writeln("Run tsc cmd\n" + ("[" + executeFrom + "] $ ").red + (tscmd).green.bold);
        ...
        if ( cmdOutput ) {
            ...
            grunt.log.writeln(("\n\n------------------------------------------------\n"
                + alertmsg
                + "\n-------------------------------").bold.red);
            END_OF_BUILD_WARNINGS.push(alertmsg);
        }
