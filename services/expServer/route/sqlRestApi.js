...
function getRows(tableName, startRowNum, rowsToFetch) {
    ...
    .then(function(res) {
        ...
        return fetchData(finalData, resultSetId, rowPosition, rowsToFetch,
                               totalRows, [], 0, 0);
    })
    .then(deferred.resolve)
    .fail(function(error) {
...
function fetchData(finalData, resultSetId, rowPosition, rowsToFetch, totalRows) {
    var deferred = PromiseHelper.deferred();
