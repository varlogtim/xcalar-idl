describe("sqlRestApi Test", function() {
    ...
    var sqlManager = require(__dirname + '/../../expServer/controllers/sqlManager.js');
    var sqlManagerDeprecated = require(__dirname + '/../../expServer/controllers/sqlManagerDeprecated.js');
    ...
    //         sqlManager.listPublishTables("sqltest")
    //         .then(function(res) {
    ...
    describe("Restful API Test", function() {
        ...
        it("Should support /deprecated/select", function(done) {
            ...
            var req = {"names": '["test"]',
                       ...
                       "checkTime": 100};
            var data = {
                url: 'http://localhost:12125/deprecated/select',
                json: req
            }
            request.post(data, function (err, res, body){
        ...
        it("Should support /xcsql/list", function(done) {
            ...
            var req = {"pattern": "*"};
            var data = {
                url: 'http://localhost:12125/xcsql/list',
                json: req
            }
            request.post(data, function (err, res, body){
