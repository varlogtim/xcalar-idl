...
'StatusReallocShrinkFailed' : 190,
'StatusTableAlreadyExists' : 191,
'StatusCliUnclosedQuotes' : 192,
'StatusRangePartError' : 193,
'StatusNewFieldNameIsBlank' : 194,
'StatusNoDataDictForFormatType' : 195,
'StatusBTreeNotFound' : 196,
'StatusBTreeKeyTypeMismatch' : 197,
'StatusBTreeDatasetMismatch' : 198,
'StatusCmdNotComplete' : 199,
'StatusInvalidResultSetId' : 200,
'StatusPositionExceedResultSetSize' : 201,
'StatusHandleInUse' : 202,
'StatusCliLineTooLong' : 203,
'StatusCliErrorReadFromFile' : 204,
'StatusInvalidTableName' : 205,
'StatusTableNameTooLong' : 206,
'StatusApiUnexpectedEOF' : 207,
'StatusStatsInvalidGroupId' : 208,
'StatusStatsInvalidGroupName' : 209,
'StatusInvalidHandle' : 210,
'StatusThriftProtocolError' : 211,
'StatusEmptyTree' : 212,
'StatusBTreeHasNoRoot' : 213,
'StatusBTreeKeyNotFound' : 214,
'StatusQaKeyValuePairNotFound' : 215,
'StatusAstMalformedEvalString' : 216,
'StatusAstNoSuchFunction' : 217,
'StatusFieldNameTooLong' : 218,
'StatusFieldNameAlreadyExists' : 219
};
...
190 : 'Failed to shrink memory allocation',
191 : 'Table already exists',
192 : 'Invalid command. Could not find matching quotes',
193 : 'Failed to compute the range partition hash function',
194 : 'Field name cannot be blank',
195 : 'No data dictionary defined for format type',
196 : 'Could not find BTree associated with table handle',
197 : 'BTree key type does not match insert message key type',
198 : 'BTree dataset identifier does not match insert message dataset identifier',
199 : 'Command is still running',
200 : 'Invalid result set ID',
201 : 'Cannot set position to beyond result set size',
202 : 'Table is in use right now and cannot be deleted',
203 : 'One of the lines in the CLI is too long',
204 : 'Encountered an error reading from file',
205 : 'Invalid table name',
206 : 'Table name is too long',
207 : 'Unexpected end-of-file attempting to read from socket',
208 : 'stats group ID is invalid',
209 : 'stats group name is invalid',
210 : 'Invalid handle',
211 : 'Error communicating across thrift connection',
212 : 'BTree is empty',
213 : 'Malformed BTree. BTree has no root',
214 : 'Could not find key in BTree',
215 : 'Could not find key-value pair',
216 : 'Malformed eval string',
217 : 'Could not find function',
218 : 'The new field name is too long',
219 : 'The field name you entered already exists'
};
