window.xcFunction = (function ($, xcFunction) {
    ...
    xcFunction.sort = function (colNum, tableNum, order) {
        ...
        .then(function() {
            ...
            var oldTableId = xcHelper.unwrapHashId(tableName);
            var newTableId = xcHelper.unwrapHashId(newTableName);
                                    ...
                                    isIncSample, newColName)
    {
        ...
        var newTableName = xcHelper.unwrapTableName(tableName) + "-GroupBy";
        ...
        .then(function(result) {
            ...
            return (XcalarGroupBy(operator, newColName, backAggCol,
                        tableName, newTableName,
