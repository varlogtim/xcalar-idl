...
'StatusSchedQueueLenExceeded' : 157,
'StatusMsgSuccess' : 158,
'StatusMsgFail' : 159,
...
'StatusDfRowNotFound' : 172,
'StatusDfValNotFound' : 173,
'StatusDsTooManyKeyValues' : 174,
'StatusTableAlreadyExists' : 175,
'StatusCliUnclosedQuotes' : 176,
'StatusRangePartError' : 177,
'StatusNewFieldNameIsBlank' : 178,
'StatusNoDataDictForFormatType' : 179,
'StatusBTreeNotFound' : 180,
'StatusCmdNotComplete' : 181,
'StatusInvalidResultSetId' : 182,
'StatusPositionExceedResultSetSize' : 183,
'StatusHandleInUse' : 184,
'StatusCliLineTooLong' : 185,
'StatusCliErrorReadFromFile' : 186,
'StatusInvalidTableName' : 187,
'StatusTableNameTooLong' : 188
};
...
157 : 'Sched queue length exceeded',
158 : 'Message success',
...
172 : 'Failed to find a row corresponding to the given key',
173 : 'Searched value was not found',
174 : 'Intended key has more than a single',
175 : 'Table already exists',
176 : 'Invalid command. Could not find matching quotes',
177 : 'Failed to compute the range partition hash function',
178 : 'Field name cannot be blank',
179 : 'No data dictionary defined for format type',
180 : 'Could not find BTree associated with table handle',
181 : 'Command is still running',
182 : 'Invalid result set ID',
183 : 'Cannot set position to beyond result set size',
184 : 'Table is in use right now and cannot be deleted',
185 : 'One of the lines in the CLI is too long',
186 : 'Encountered an error reading from file',
187 : 'Invalid table name',
188 : 'Table name is too long'
};
