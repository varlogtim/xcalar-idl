...
'StatusReallocShrinkFailed' : 188,
'StatusTableAlreadyExists' : 189,
'StatusCliUnclosedQuotes' : 190,
'StatusRangePartError' : 191,
'StatusNewFieldNameIsBlank' : 192,
'StatusNoDataDictForFormatType' : 193,
'StatusBTreeNotFound' : 194,
'StatusBTreeKeyTypeMismatch' : 195,
'StatusBTreeDatasetMismatch' : 196,
'StatusCmdNotComplete' : 197,
'StatusInvalidResultSetId' : 198,
'StatusPositionExceedResultSetSize' : 199,
'StatusHandleInUse' : 200,
'StatusCliLineTooLong' : 201,
'StatusCliErrorReadFromFile' : 202,
'StatusInvalidTableName' : 203,
'StatusTableNameTooLong' : 204,
'StatusApiUnexpectedEOF' : 205,
'StatusStatsInvalidGroupId' : 206,
'StatusStatsInvalidGroupName' : 207,
'StatusInvalidHandle' : 208,
'StatusThriftProtocolError' : 209,
'StatusEmptyTree' : 210,
'StatusBTreeHasNoRoot' : 211,
'StatusBTreeKeyNotFound' : 212,
'StatusQaKeyValuePairNotFound' : 213,
'StatusAstMalformedEvalString' : 214,
'StatusAstNoSuchFunction' : 215,
'StatusFieldNameTooLong' : 216,
'StatusFieldNameAlreadyExists' : 217
};
...
188 : 'Failed to shrink memory allocation',
189 : 'Table already exists',
190 : 'Invalid command. Could not find matching quotes',
191 : 'Failed to compute the range partition hash function',
192 : 'Field name cannot be blank',
193 : 'No data dictionary defined for format type',
194 : 'Could not find BTree associated with table handle',
195 : 'BTree key type does not match insert message key type',
196 : 'BTree dataset identifier does not match insert message dataset identifier',
197 : 'Command is still running',
198 : 'Invalid result set ID',
199 : 'Cannot set position to beyond result set size',
200 : 'Table is in use right now and cannot be deleted',
201 : 'One of the lines in the CLI is too long',
202 : 'Encountered an error reading from file',
203 : 'Invalid table name',
204 : 'Table name is too long',
205 : 'Unexpected end-of-file attempting to read from socket',
206 : 'stats group ID is invalid',
207 : 'stats group name is invalid',
208 : 'Invalid handle',
209 : 'Error communicating across thrift connection',
210 : 'BTree is empty',
211 : 'Malformed BTree. BTree has no root',
212 : 'Could not find key in BTree',
213 : 'Could not find key-value pair',
214 : 'Malformed eval string',
215 : 'Could not find function',
216 : 'The new field name is too long',
217 : 'The field name you entered already exists'
};
