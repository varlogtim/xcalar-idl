...
getTHandle = runEntity.getTHandle = function() {
    return tHandle;
};

setupThrift = runEntity.setupThrift = function(hostname) {
...
setupHostName = runEntity.setupHostName = function() {
    ...
    for (var i = 1, len = arguments.length; i < len; i++) {
        ...
        if (status === StatusT.StatusOk) {
            ...
            if (status === StatusT.StatusConnReset ||
                ...
                // LOCK THE SCREEN
                if (!has_require && !xcManager.isInSetup()) {
...
// XXX hack
if (has_require && global != null) {
    global.getUnsortedTableName = getUnsortedTableName;
}
...
// ========================= MAIN FUNCTIONS  =============================== //
XcalarGetVersion = runEntity.XcalarGetVersion = function XcalarGetVersion(connectionCheck) {
...
XcalarGetLicense = runEntity.XcalarGetLicense = function XcalarGetLicense() {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarGetNodeName = runEntity.XcalarGetNodeName = function XcalarGetNodeName(nodeId) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarUpdateLicense = runEntity.XcalarUpdateLicense = function XcalarUpdateLicense(newLicense) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarPreview = runEntity.XcalarPreview = function XcalarPreview(url, fileNamePattern, isRecur, numBytesRequested, offset) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
 ...
 */
XcalarLoad = runEntity.XcalarLoad = function XcalarLoad(url, format, datasetName, options, txId) {
    options = options || {};
...
XcalarAddLocalFSExportTarget = runEntity.XcalarAddLocalFSExportTarget = function XcalarAddLocalFSExportTarget(targetName, path, txId) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarAddUDFExportTarget = runEntity.XcalarAddUDFExportTarget = function XcalarAddUDFExportTarget(targetName, path, udfName, txId) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarRemoveExportTarget = runEntity.XcalarRemoveExportTarget = function XcalarRemoveExportTarget(targetName, targetType) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarListExportTargets = runEntity.XcalarListExportTargets = function XcalarListExportTargets(typePattern, namePattern) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarExport = runEntity.XcalarExport = function XcalarExport(tableName, exportName, targetName, numColumns,
...
XcalarLockDataset = runEntity.XcalarLockDataset = function XcalarLockDataset(dsName) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarUnlockDataset = runEntity.XcalarUnlockDataset = function XcalarUnlockDataset(dsName, txId) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarDestroyDataset = runEntity.XcalarDestroyDataset = function XcalarDestroyDataset(dsName, txId) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarIndexFromDataset = runEntity.XcalarIndexFromDataset = function XcalarIndexFromDataset(datasetName, key, tablename, prefix, txId) {
...
XcalarIndexFromTable = runEntity.XcalarIndexFromTable = function XcalarIndexFromTable(srcTablename, key, tablename, ordering,
                              txId, unsorted) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarDeleteTable = runEntity.XcalarDeleteTable = function XcalarDeleteTable(tableName, txId, isRetry) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
    var deferred = jQuery.Deferred();
...
XcalarDeleteConstants = runEntity.XcalarDeleteConstants = function XcalarDeleteConstants(constantPattern, txId) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
    var deferred = jQuery.Deferred();
...
XcalarRenameTable = runEntity.XcalarRenameTable = function XcalarRenameTable(oldTableName, newTableName, txId) {
...
XcalarFetchData = runEntity.XcalarFetchData = function XcalarFetchData(resultSetId, rowPosition, rowsToFetch, totalRows, data, tryCnt) {
    var deferred = jQuery.Deferred();
    if (tryCnt == null) {
        tryCnt = 0;
    }
...
XcalarGetConfigParams = runEntity.XcalarGetConfigParams = function XcalarGetConfigParams() {
    if (tHandle == null) {
...
XcalarSetConfigParams = runEntity.XcalarSetConfigParams = function XcalarSetConfigParams(pName, pValue) {
    if (tHandle == null) {
        return PromiseHelper.resolve(0);
    }
...
// XXX NOT TESTED
XcalarGetDatasetCount = runEntity.XcalarGetDatasetCount = function XcalarGetDatasetCount(dsName) {
    var deferred = jQuery.Deferred();
    if (insertError(arguments.callee, deferred)) {
        return (deferred.promise());
    }
...
XcalarGetDatasetMeta = runEntity.XcalarGetDatasetMeta = function XcalarGetDatasetMeta(dsName) {
    if (tHandle == null) {
        return PromiseHelper.resolve(0);
    }
...
XcalarGetTableMeta = runEntity.XcalarGetTableMeta = function XcalarGetTableMeta(tableName) {
    var deferred = jQuery.Deferred();
    if (insertError(arguments.callee, deferred)) {
        return (deferred.promise());
    }
...
XcalarGetTableCount = runEntity.XcalarGetTableCount = function XcalarGetTableCount(tableName) {
    var deferred = jQuery.Deferred();
    if (insertError(arguments.callee, deferred)) {
        return (deferred.promise());
    }
...
XcalarGetDatasets = runEntity.XcalarGetDatasets = function XcalarGetDatasets() {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarGetDatasetUsers = runEntity.XcalarGetDatasetUsers = function XcalarGetDatasetUsers(dsName) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarGetConstants = runEntity.XcalarGetConstants = function XcalarGetConstants(constantName) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
    var deferred = jQuery.Deferred();
...
XcalarGetTables = runEntity.XcalarGetTables = function XcalarGetTables(tableName) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
    var deferred = jQuery.Deferred();
...
XcalarGetDSNode = runEntity.XcalarGetDSNode = function XcalarGetDSNode(datasetName) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
    var deferred = jQuery.Deferred();
...
XcalarShutdown = runEntity.XcalarShutdown = function XcalarShutdown(force) {
    if (tHandle == null) {
        return PromiseHelper.resolve(null);
    }
    if (force == null) {
...
XcalarStartNodes = runEntity.XcalarStartNodes = function XcalarStartNodes(numNodes) {
    if (tHandle == null) {
        return PromiseHelper.resolve(null);
    }
    var deferred = jQuery.Deferred();
...
XcalarGetStats = runEntity.XcalarGetStats = function XcalarGetStats(nodeId) {
...
XcalarGetTableRefCount = runEntity.XcalarGetTableRefCount = function XcalarGetTableRefCount(tableName) {
    if (tHandle == null) {
        return PromiseHelper.resolve(0);
    }
...
XcalarMakeResultSetFromTable = runEntity.XcalarMakeResultSetFromTable = function XcalarMakeResultSetFromTable(tableName) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(0);
    }
...
XcalarMakeResultSetFromDataset = runEntity.XcalarMakeResultSetFromDataset = function XcalarMakeResultSetFromDataset(datasetName) {
    if (tHandle == null) {
        return PromiseHelper.resolve(0);
    }
...
XcalarSetAbsolute = runEntity.XcalarSetAbsolute = function XcalarSetAbsolute(resultSetId, position) {
    if (tHandle == null) {
        return PromiseHelper.resolve(0);
    }
...
XcalarGetNextPage = runEntity.XcalarGetNextPage = function XcalarGetNextPage(resultSetId, numEntries) {
    if ([null, undefined].indexOf(tHandle) !== -1) {
        return PromiseHelper.resolve(null);
    }
...
XcalarSetFree = runEntity.XcalarSetFree = function XcalarSetFree(resultSetId) {
    if (tHandle == null) {
        return PromiseHelper.resolve(null);
    }
...
XcalarFilter = runEntity.XcalarFilter = function XcalarFilter(evalStr, srcTablename, dstTablename, txId) {
    if (tHandle == null) {
        return PromiseHelper.resolve(null);
    }
...
XcalarMapWithInput = runEntity.XcalarMapWithInput = function XcalarMapWithInput(txId, inputStruct) {
    if (tHandle == null) {
        return PromiseHelper.resolve(null);
    }
...
XcalarMap = runEntity.XcalarMap = function XcalarMap(newFieldNames, evalStrs, srcTablename, dstTablename,
...
XcalarAggregate = runEntity.XcalarAggregate = function XcalarAggregate(evalStr, dstAggName, srcTablename, txId) {
    if (tHandle == null) {
        return PromiseHelper.resolve(null);
    }
...
XcalarJoin = runEntity.XcalarJoin = function XcalarJoin(left, right, dst, joinType, leftRename, rightRename, txId) {
    if (tHandle == null) {
        return PromiseHelper.resolve(null);
    }
    var coll = true;
...
XcalarGroupByWithInput = runEntity.XcalarGroupByWithInput = function XcalarGroupByWithInput(txId, inputStruct) {
    var deferred = jQuery.Deferred();
    if (Transaction.checkCanceled(txId)) {
        return (deferred.reject(StatusTStr[StatusT.StatusCanceled]).promise());
    }
...
XcalarGroupBy = runEntity.XcalarGroupBy = function XcalarGroupBy(operators, newColNames, aggColNames, tableName,
...
XcalarProject = runEntity.XcalarProject = function XcalarProject(columns, tableName, dstTableName, txId) {
    var deferred = jQuery.Deferred();
    if (Transaction.checkCanceled(txId)) {
        return (deferred.reject(StatusTStr[StatusT.StatusCanceled]).promise());
    }
...
XcalarGenRowNum = runEntity.XcalarGenRowNum = function XcalarGenRowNum(srcTableName, dstTableName, newFieldName, txId) {
    var deferred = jQuery.Deferred();
    if (Transaction.checkCanceled(txId)) {
        return (deferred.reject(StatusTStr[StatusT.StatusCanceled]).promise());
    }
...
XcalarQuery = runEntity.XcalarQuery = function XcalarQuery(queryName, queryString, txId) {
...
XcalarQueryCheck = runEntity.XcalarQueryCheck = function XcalarQueryCheck(queryName, canceling) {
...
XcalarQueryWithCheck = runEntity.XcalarQueryWithCheck = function(queryName, queryString, txId) {
    var deferred = jQuery.Deferred();
    if (Transaction.checkCanceled(txId)) {
        return (deferred.reject(StatusTStr[StatusT.StatusCanceled]).promise());
    }
