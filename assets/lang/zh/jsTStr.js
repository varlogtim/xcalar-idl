...
'Uploading': '上传',
'Upgrading': '升级',
'HighXcalarMemUsage': 'Xcalar最高内存使用率',
'XcalarMemUsage': 'Xcalar平均内存使用率',
'Retry': '重试',
'Overwrite': '覆盖',
'NoResult': '无搜索结果',
'deleting': '删除中',
...
'InvalidTargetName': '目标名称应以字母开头，仅包含字母，数字，空格，连字符（ - ）或下划线（_)',
...
"TicketError": "抱歉，我们现在无法为提交您的技术支持请求。请前往https://myxcalar.zendesk.com提交您的请求。",
"EmailEnabled": "发送邮件",
...
"Activate": "激活啊工作簿",
 "ActivateInstr": "您确定要激活工作簿吗?",
"Switch": '切换工作簿',
'SwitchWarn': '当前工作簿正在执行操作\"<op>\", 您确定要切换工作簿吗?',
"ReturnWKBK": '返回工作簿',
"EditName": '编辑工作簿名称和注释',
"Download": "Download",
"Duplicate": '复制工作簿',
...
"ContainsFileErrors": "Your dataset contains 1 file error. Click to view.",
