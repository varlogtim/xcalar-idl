...
'PartialDeleteTableFail': '一些表无法删除',
'CouldNotDelete': '无法删除',
'ExportTable': '导出表',
'ExportFailed': '导出失败',
'Aggregate': '执行汇总',
...
'Redo': '重做：<op>',
'NoRedo': '没有操作可以恢复',
'LockedTableUndo': '而表被锁定不能撤消',
'LockedTableRedo': '而表被锁定不能重做',
'CloseQG': '点击隐藏查询图',
'OpenQG': '点击查看查询图',
'Bookmark': '点击添加书签',
'Bookmarked': '书签',
'CopyLog': '在SQL日志复制到剪贴板',
'GenBundle': '生成支持包',
'ToGridView': '切换到网格视图',
'ToListView': '切换到列表视图',
'ClickCollapse': '点击崩溃',
'CollapsedTable': '1台被隐藏',
'CollapsedTables': '<number>表被隐藏'
};
CommonTxtTstr = {
...
'BackToOrig': '回到原来的',
'Optional': '可选的',
'LogoutWarn': '你有未保存的更改，请保存或您可能失去工作。',
'LeaveWarn': '你离开xcalar',
'GenBundle': '生成包',
'GenBundleDone': '生成的捆绑',
'GenBundleFail': '束产生失败',
...
'InvalidTableName': '表名不能包含以下任何字符：*＃\'\“',
'InvalidAggName': '总名称必须以前缀@',
'InvalidAggLength': '总名称必须以@为前缀，后加名',
...
'InvalidWin': '不能窗口中的排序的表',
'InvalidQuery': '查询失败',
'BracketsMis': '你的函数字符串有不匹配的括号内。',
'TooLong': '请用不超过255个字符',
'TablesNotDeleted': '下表中未删除：',
'NoTablesDeleted': '没有表被删除。',
'LargeImgSave': '无法保存图像',
'LargeImgTab': '无法打开图片',
'LargeImgText': '图像超出你的浏览器\的最大允许大小',
'QGNoExpand': '这个查询图已经达到了您的浏览器\的最大允许大小。',
'InvalidExt': '无效的扩展',
...
'NoLessNum': '请输入大于或等于一个值<num>',
'NoBiggerNum': '请输入小于或等于值<num>',
'TableNotDeleted': '表<name>未被删除。',
'AggConflict': '聚合“@ <name>”已经存在，请选择其他名称。'
};
TipsTStr = {
'Scrollbar': '滚动表在这里',
'DataType': '数据类型',
...
'Datacart': 'datacart区，您可以添加从数据集的列到你的购物车。这些列将被用来在活动工作表中创建表。您还可以在工作表屏幕中添加列。',
...
'SuggTitle': '建议排序',
'SuggInstr': '选择“数字”，以数字顺序排序前投的列<type>。非数字的行排序过程中被删除。',
'SuggMsg': '此列可以数字或字母顺序排序。你想如何排序？',
'CastToNum': '数字',
'NoCast': '按字母顺序'
};
JoinTStr = {
...
'RowInfo': '显示<span><row></span>结果'
};
WKBKTStr = {
'NoWkbk': '没有簿为用户',
'Location': '工作簿的浏览器',
'NewWKBK': '新的工作簿',
'NewWKBKInstr': '你好<b><user></b>中，你没有一个工作簿呢。您可以创建新的工作簿，继续工作簿或复制工作簿',
...
'DSSourceHint': '请尝试其他路径，或使用其它协议',
'FileOversize': '该文件夹中的文件太多，看不懂，请与URL直接加载',
'InvalidHDFS': '无效HDFS路径，有效的格式为：“主机名/ pathtofile”'
};
DSFormTStr = {
'LoadConfirm': '点数据',
'NoHeader': '你没有检查头选项，以促进第一行表头。你将不能够在这之后的表头更改默认。',
'InvalidDelim': '无效的分隔符。'
};
DataCartStr = {
'NoCartTitle': '没有选择的表',
...
'LoadJSON': '格式JSON',
'LoadExcel': '格式为Excel',
'LoadExcelWithHeader': '格式为Excel，促进头部',
'LoadUDF': '使用UDF解析数据集',
'NoDelim': '你没有选择分隔符。',
'NoHeader': '你没有选择标题行。',
...
'PullAll': '拉各领域',
'Compare': '单击以选中对比',
'SelectOther': '从表中选择另一个单元格的数据进行比较',
'SeeAll': '查看全部',
'Original': '原版的',
'XcOriginated': 'xcalar起源',
'SeeAllTip': '查看所有领域',
