...
module.exports = {
    ...
    "dataflow": {
        ...
        "LinkAfterExecutionHint": "If the checkbox is checked, link in nodes that reference the link out node will reuse the node's result directly. Otherwise link in nodes will execute the dataflow to gerenate the result",
    ...
    "joinView": {
        "header": "Join",
        "instr": "First, select the column from the left node that you would like to join. Next, select the node followed by the column from the right that you would like to join.",
        "JoinType": "Join Type",
