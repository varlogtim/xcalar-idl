...
module.exports = {
    ...
    "dag": {
        ...
        "CreateOptimized": "Show Physical Plan",
        ...
        "viewOptimizedDataflow": "View Physical plan",
        "findOptimizedSource": "Find Original PLan",
        "NumOperatorNodes": "No. Operators",
        "ViewOnly": "View only",
        "ViewOnlyHint": "To modify this logical plan, you must convert from the current read-only version to an editable plan. Note: Any modification made to the plan will not be reflected in the original SQL.",
        "UseInSQL": "Use In SQL",
