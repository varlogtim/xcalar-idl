...
module.exports = {
    ...
    "TooltipTStr": {
        ...
        "RawDSUDFModule": "Select an existing import scalar fn module or 'WRITE PARSER USING JUPYTER' to create a module.",
    ...
    "dsForm": {
        ...
        "ApplyUDF": "Apply Scalar Fn and Preview Result",
        ...
        "DebugParser": "Debug Import Scalar Fn Using Jupyter",
        "Module": "Module",
        "Function": "Function",
        "SeeMore": "See More",
        "SeeLess": "See Less",
        ...
        "UDFArgs": "Scalar Fn Args",
        "UDFArgsHint": "Specify the scalar fn arguments (other than fullPath and inStream) in JSON format"
    },
    ...
    "dataflow": {
        ...
        "DownloadDFInstr": "If downloaded as module, it will include <b>ONLY</b> the local scalar fns, and will not include any scalar fns it uses that are from the shared space",
        ...
        "overwriteUdf": "Overwrite Scalar Fn",
        "overwriteUdfHint": "Overwrite scalar fn of the same module name with those inside this application builder module",
    ...
    "DFLink": {
        "InHeader": "Link In",
        "InInstr": "Select a Link Out Node or a table as a source for the Link In Node.",
        "ResultSetTip": "To get a table name, find the Node whose table you want to use, click on the Node to display its configuration and copy the table name from the JSON.",
        "OutHeader": "Link Out",
        "DFName": "Module Name",
        "OutName": "Link Out Reference Name",
        "Schema": "Column Schema",
        "OutHelp": "If this check box is checked, the Link In Node that references this Link Out Node, triggers the execution of this Link Out Node. Otherwise, the Link In Node uses the existing table of this Link Out Node."
    },
    ...
    "jupyter": {
        ...
        "NewName": "New Name",
        "PUBLISH": "Convert",
        "TemplateInstr": "Fill in the fields below prior to creating a Scalar Fn template.",
        "TemplateInstrMapUDF": "Fill in the fields below prior to creating a Map Scalar Fn" +
                    ". An additional cell will be provided to test your scalar fn.",
        "TemplateInstrImportUDF": "Fill in the fields below prior to creating an Import Scalar Fn.",
        "ConnectWB": "Connect to Xcalar Project",
        "CreateUDF": "Create Map Saclar Fn",
        "CreateImportUDF": "Create Import Scalar Fn",
        "UDFTemplate": "Scalar Fn Template",
