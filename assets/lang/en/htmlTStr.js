...
module.exports = {
    ...
    "SQL": {
        ...
        "SQLFuncHint": "Tips: A table creator function takes one ore more tables as input and output a table. Table creator function can be called in query, e.g, select * from fn(Table1, Table2...). You can visually create a table creator function using the graph interface in the Transformation & Business Logic Panel.",
        "EditUDF": "Add/Edit UDF",
        "UDFHint": "Tips: UDF (User Defined Function) is customized python function that accept one or more fields on table as input and output a string field. UDF can be used in SQL query, e.g, select udf(Field1, Field2...) from Table. You can add/edit UDFs in the UDF panel.",
    ...
    "monitor": {
        ...
        "Setup": "Administration",
        "showDataCol": "Show data column in result set view",
        "showDataColHint": "Data Column shows the raw data for each row of the result set",
    ...
    "dataflow": {
        ...
        "DownloadDFInstr": "If downloaded as module, it will include <b>ONLY</b> the local UDFs, and will not include any UDFs it uses that are from the shared space",
    ...
    "dag": {
        ...
        "lockTable": "Pin Result",
        "unlockTable": "Unpin Result",
        "inspectSQL": "Inspect",
        "expandSQL": "Expand",
