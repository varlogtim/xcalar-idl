...
ErrTStr = {
    ...
    'InvalidAggName': 'Aggregate name should start with letter and contain only letters, digits, hyphens(-) or underscores(_)',
    'InvalidTableName': 'Table name should start with letter and contain only letters, digits, hyphens(-) or underscores(_)',
    'InvalidWBName': 'Workbook name should start with a letter and contain only letters, digits, hyphens(-) or underscores(_)',
