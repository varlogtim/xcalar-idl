...
TblTStr = {
    ...
    "PreviewInstr": "To start using table features, please use the SQL editor shown on side bar labeled \"SQL\" or select the \"Write SQL\" button below in SQL Mode to get started. You can also switch to Developer Mode and start from the table node in the application builder's module.",
