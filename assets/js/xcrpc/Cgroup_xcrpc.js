...
CgroupService.prototype = {
    process: function(cgRequest) {
        ...
        var response = this.client.execute("Cgroup", "Process", anyWrapper)
        .then(function(responseData) {
            ...
            deferred.resolve(cgResponse);
        })
        .fail(function(error) {
            console.log("process fail:" + JSON.stringify(error));
