...
/**
 * repeated xcalar.compute.localtypes.Operator.XcalarApiEval maps = 6;
...
proto.xcalar.compute.localtypes.PublishedTable.SelectRequest.prototype.getMapsList = function() {
  return /** @type{!Array<!proto.xcalar.compute.localtypes.Operator.XcalarApiEval>} */ (
    jspb.Message.getRepeatedWrapperField(this, xcalar_compute_localtypes_Operator_pb.XcalarApiEval, 6));
};
...
proto.xcalar.compute.localtypes.PublishedTable.SelectRequest.prototype.addMaps = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.xcalar.compute.localtypes.Operator.XcalarApiEval, opt_index);
};
...
/**
 * repeated xcalar.compute.localtypes.Operator.XcalarApiEval group_bys = 7;
 * @return {!Array<!proto.xcalar.compute.localtypes.Operator.XcalarApiEval>}
 */
proto.xcalar.compute.localtypes.PublishedTable.SelectRequest.prototype.getGroupBysList = function() {
  return /** @type{!Array<!proto.xcalar.compute.localtypes.Operator.XcalarApiEval>} */ (
    jspb.Message.getRepeatedWrapperField(this, xcalar_compute_localtypes_Operator_pb.XcalarApiEval, 7));
};
...
proto.xcalar.compute.localtypes.PublishedTable.SelectRequest.prototype.addGroupBys = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.xcalar.compute.localtypes.Operator.XcalarApiEval, opt_index);
};
...
/**
 * repeated xcalar.compute.localtypes.Operator.XcalarApiColumn columns = 9;
...
proto.xcalar.compute.localtypes.PublishedTable.SelectRequest.prototype.getColumnsList = function() {
  return /** @type{!Array<!proto.xcalar.compute.localtypes.Operator.XcalarApiColumn>} */ (
    jspb.Message.getRepeatedWrapperField(this, xcalar_compute_localtypes_Operator_pb.XcalarApiColumn, 9));
};
...
proto.xcalar.compute.localtypes.PublishedTable.SelectRequest.prototype.addColumns = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 9, opt_value, proto.xcalar.compute.localtypes.Operator.XcalarApiColumn, opt_index);
};
