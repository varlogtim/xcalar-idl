...
XcalarApiDeleteDagNodeStatusT.prototype.write = function(output) {
  ...
  if (this.refs !== null && this.refs !== undefined) {
    ...
    for (var iter191 in this.refs)
    {
      if (this.refs.hasOwnProperty(iter191))
      {
        iter191 = this.refs[iter191];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem198 = null;
          elem198 = new XcalarApiDeleteDagNodeStatusT();
          elem198.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem206 = null;
          elem206 = new XcalarApiDeleteDatasetStatusT();
          elem206.read(input);
          this.statuses.push(elem206);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiDeleteDatasetsOutputT.prototype.write = function(output) {
  ...
  if (this.statuses !== null && this.statuses !== undefined) {
    output.writeFieldBegin('statuses', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRUCT, this.statuses.length);
    for (var iter207 in this.statuses)
    {
      if (this.statuses.hasOwnProperty(iter207))
      {
        iter207 = this.statuses[iter207];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem214 = null;
          elem214 = new XcalarApiTopOutputPerNodeT();
          elem214.read(input);
          this.topOutputPerNode.push(elem214);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiTopOutputT.prototype.write = function(output) {
  ...
  if (this.topOutputPerNode !== null && this.topOutputPerNode !== undefined) {
    ...
    for (var iter215 in this.topOutputPerNode)
    {
      if (this.topOutputPerNode.hasOwnProperty(iter215))
      {
        iter215 = this.topOutputPerNode[iter215];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem222 = null;
          elem222 = new XcalarApiMemoryUsagePerTagT();
          elem222.read(input);
          this.memOutputPerTag.push(elem222);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiMemoryUsagePerNodeT.prototype.write = function(output) {
  ...
  if (this.memOutputPerTag !== null && this.memOutputPerTag !== undefined) {
    ...
    for (var iter223 in this.memOutputPerTag)
    {
      if (this.memOutputPerTag.hasOwnProperty(iter223))
      {
        iter223 = this.memOutputPerTag[iter223];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem230 = null;
          elem230 = new XcalarApiMemoryUsagePerNodeT();
          elem230.read(input);
          this.memOutputPerNode.push(elem230);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiMemoryOutputT.prototype.write = function(output) {
  ...
  if (this.memOutputPerNode !== null && this.memOutputPerNode !== undefined) {
    ...
    for (var iter231 in this.memOutputPerNode)
    {
      if (this.memOutputPerNode.hasOwnProperty(iter231))
      {
        iter231 = this.memOutputPerNode[iter231];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem238 = null;
          elem238 = new XcalarApiNodeOpStatsT();
          elem238.read(input);
          this.nodeOpStats.push(elem238);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiPerNodeOpStatsT.prototype.write = function(output) {
  ...
  if (this.nodeOpStats !== null && this.nodeOpStats !== undefined) {
    ...
    for (var iter239 in this.nodeOpStats)
    {
      if (this.nodeOpStats.hasOwnProperty(iter239))
      {
        iter239 = this.nodeOpStats[iter239];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i245 = 0; _i245 < _size240; ++_i245)
        {
          ...
          this.testNamePatterns.push(elem246);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiStartFuncTestInputT.prototype.write = function(output) {
  ...
  if (this.testNamePatterns !== null && this.testNamePatterns !== undefined) {
    ...
    for (var iter247 in this.testNamePatterns)
    {
      if (this.testNamePatterns.hasOwnProperty(iter247))
      {
        iter247 = this.testNamePatterns[iter247];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem254 = null;
          elem254 = new XcalarApiConfigParamT();
          elem254.read(input);
          this.parameter.push(elem254);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiGetConfigParamsOutputT.prototype.write = function(output) {
  ...
  if (this.parameter !== null && this.parameter !== undefined) {
    ...
    for (var iter255 in this.parameter)
    {
      if (this.parameter.hasOwnProperty(iter255))
      {
        iter255 = this.parameter[iter255];
...
XcalarApiInputT.prototype.write = function(output) {
  ...
  if (this.supportGenerateInput !== null && this.supportGenerateInput !== undefined) {
    output.writeFieldBegin('supportGenerateInput', Thrift.Type.STRUCT, 77);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem262 = null;
          elem262 = input.readI64().value;
          this.numRowsPerNode.push(elem262);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiDagNodeT.prototype.write = function(output) {
  ...
  if (this.numWorkCompleted !== null && this.numWorkCompleted !== undefined) {
    output.writeFieldBegin('numWorkCompleted', Thrift.Type.I64, 10);
    output.writeI64(this.numWorkCompleted);
    output.writeFieldEnd();
  }
  if (this.numWorkTotal !== null && this.numWorkTotal !== undefined) {
    output.writeFieldBegin('numWorkTotal', Thrift.Type.I64, 11);
    output.writeI64(this.numWorkTotal);
    output.writeFieldEnd();
  }
  if (this.elapsed !== null && this.elapsed !== undefined) {
    output.writeFieldBegin('elapsed', Thrift.Type.STRUCT, 12);
    this.elapsed.write(output);
    output.writeFieldEnd();
  }
  if (this.inputSize !== null && this.inputSize !== undefined) {
    output.writeFieldBegin('inputSize', Thrift.Type.I64, 13);
  ...
  if (this.numNodes !== null && this.numNodes !== undefined) {
    output.writeFieldBegin('numNodes', Thrift.Type.I32, 16);
    output.writeI32(this.numNodes);
    output.writeFieldEnd();
  }
  if (this.numRowsPerNode !== null && this.numRowsPerNode !== undefined) {
    output.writeFieldBegin('numRowsPerNode', Thrift.Type.LIST, 17);
    output.writeListBegin(Thrift.Type.I64, this.numRowsPerNode.length);
    for (var iter263 in this.numRowsPerNode)
    {
      if (this.numRowsPerNode.hasOwnProperty(iter263))
      {
        iter263 = this.numRowsPerNode[iter263];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem270 = null;
          elem270 = new XcalarApiDagNodeT();
          elem270.read(input);
          this.node.push(elem270);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiDagOutputT.prototype.write = function(output) {
  ...
  if (this.node !== null && this.node !== undefined) {
    ...
    for (var iter271 in this.node)
    {
      if (this.node.hasOwnProperty(iter271))
      {
        iter271 = this.node[iter271];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem278 = null;
          elem278 = new DagRetinaDescT();
          elem278.read(input);
          this.retinaDescs.push(elem278);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiListRetinasOutputT.prototype.write = function(output) {
  ...
  if (this.retinaDescs !== null && this.retinaDescs !== undefined) {
    ...
    for (var iter279 in this.retinaDescs)
    {
      if (this.retinaDescs.hasOwnProperty(iter279))
      {
        iter279 = this.retinaDescs[iter279];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem286 = null;
          elem286 = new XcalarApiSessionT();
          elem286.read(input);
          this.sessions.push(elem286);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiSessionListOutputT.prototype.write = function(output) {
  ...
  if (this.sessions !== null && this.sessions !== undefined) {
    ...
    for (var iter287 in this.sessions)
    {
      if (this.sessions.hasOwnProperty(iter287))
      {
        iter287 = this.sessions[iter287];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem294 = null;
          elem294 = new XcalarApiUdfAddUpdateOutputT();
          elem294.read(input);
          this.udfModuleStatuses.push(elem294);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiImportRetinaOutputT.prototype.write = function(output) {
  ...
  if (this.udfModuleStatuses !== null && this.udfModuleStatuses !== undefined) {
    ...
    for (var iter295 in this.udfModuleStatuses)
    {
      if (this.udfModuleStatuses.hasOwnProperty(iter295))
      {
        iter295 = this.udfModuleStatuses[iter295];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem302 = null;
          elem302 = new XcalarApiFuncTestOutputT();
          elem302.read(input);
          this.testOutputs.push(elem302);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiStartFuncTestOutputT.prototype.write = function(output) {
  ...
  if (this.testOutputs !== null && this.testOutputs !== undefined) {
    ...
    for (var iter303 in this.testOutputs)
    {
      if (this.testOutputs.hasOwnProperty(iter303))
      {
        iter303 = this.testOutputs[iter303];
...
XcalarApiListFuncTestOutputT.prototype.write = function(output) {
  ...
  if (this.testNames !== null && this.testNames !== undefined) {
    ...
    for (var iter311 in this.testNames)
    {
      if (this.testNames.hasOwnProperty(iter311))
      {
        iter311 = this.testNames[iter311];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i317 = 0; _i317 < _size312; ++_i317)
        {
          ...
          this.bytesPerNode.push(elem318);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiDatasetMemoryUsageT.prototype.write = function(output) {
  ...
  if (this.bytesPerNode !== null && this.bytesPerNode !== undefined) {
    ...
    for (var iter319 in this.bytesPerNode)
    {
      if (this.bytesPerNode.hasOwnProperty(iter319))
      {
        iter319 = this.bytesPerNode[iter319];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem326 = null;
          elem326 = new XcalarApiTableMemoryUsageT();
          elem326.read(input);
          this.tableMemory.push(elem326);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiSessionMemoryUsageT.prototype.write = function(output) {
  ...
  if (this.tableMemory !== null && this.tableMemory !== undefined) {
    ...
    for (var iter327 in this.tableMemory)
    {
      if (this.tableMemory.hasOwnProperty(iter327))
      {
        iter327 = this.tableMemory[iter327];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem334 = null;
          elem334 = new XcalarApiSessionMemoryUsageT();
          elem334.read(input);
          this.sessionMemory.push(elem334);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
XcalarApiUserMemoryUsageT.prototype.write = function(output) {
  ...
  if (this.sessionMemory !== null && this.sessionMemory !== undefined) {
    ...
    for (var iter335 in this.sessionMemory)
    {
      if (this.sessionMemory.hasOwnProperty(iter335))
      {
        iter335 = this.sessionMemory[iter335];
