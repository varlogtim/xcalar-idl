...
(function createConstructorsV2(win) {
    ...
    win.METAConstructorV2 = (function() {
        ...
        */
        function METAConstructorV2(options) {
            options = options || {};
            ...
            if (__isParentVersion(options)) {
                METAConstructorV2.restore(self, options, version);
            }
            return self;
        }
    ...
    win.EMetaConstructorV2 = (function() {
        ...
        */
        function EMetaConstructorV2(options) {
            options = options || {};
            ...
            if (__isParentVersion(options)) {
                EMetaConstructorV2.restore(self, options, version);
            }
            return self;
        }
    ...
    win.UserInfoConstructorV2 = (function() {
        ...
        */
        function UserInfoConstructorV2(options) {
            options = options || {};
            ...
            if (__isParentVersion(options)) {
                UserInfoConstructorV2.restore(self, options, version);
            }
            return self;
        }
