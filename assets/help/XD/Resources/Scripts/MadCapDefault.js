...
(function () {
            ...
            MadCap.WebHelp.HelpSystem.LoadHelpSystem(helpSystemPath).done(function (helpSystem) {
                ...
                $tocUls.each(function () {
                    if ($(this).hasClass("off-canvas-list")) {
                        SetOffCanvasMenuStyle(_HelpSystem.GetCurrentSkin());
                    }
                });
    ...
    function GoToSearchResults(e) {
        ...
        var currentUrl = MadCap.Utilities.Url.GetDocumentUrl();
        var searchPrefix = isTriPane ? '#' + _searchPrefixTri : '?' + _searchPrefixTop;
    ...
    function SetOffCanvasMenuStyle(skin) {
        if (skin) {
            var menuStyle = skin.WebHelpOptions.OffCanvasMenuStyle;
            var $menu = $(".off-canvas-list");
    ...
    function TitleBarStickyChange() {
        ...
        if ($mag.length) {
            ...
            if ($titleBar.hasClass("is-stuck")) {
                ...
                new Foundation.Magellan($mag, { barOffset: titleBarHeight + offset });
            } else {
                new Foundation.Magellan($mag, { barOffset: offset });
            }
            $mag.foundation('calcPoints');
        }
