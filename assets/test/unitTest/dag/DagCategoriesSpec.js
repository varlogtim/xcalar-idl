describe("DagCategories Test", function() {
    ...
    describe("DagCategories", function() {
        it("get categories should work", function() {
            ...
            expect(categories[9].operators.length).to.equal(6);
        ...
        it("update for sqlFunc should work", function() {
            ...
            expect(categories[8].operators[6].node instanceof DagNodeDataset).to.be.true;
            expect(categories[8].operators[7].node instanceof DagNodeIMDTable).to.be.true;
            expect(categories[8].operators[8].node instanceof DagNodeDFIn).to.be.true;
        });
    ...
    describe("DagCategory", function() {
        ...
        it('removeOperatorById', function() {
            ...
            expect(inCategory.isExistOperatorName("Map")).to.be.true;
            expect(inCategory.getOperators().length).to.equal(4);
            inCategory.removeOperatorById(mapId);
            expect(inCategory.getOperators().length).to.equal(3);
            expect(inCategory.isExistOperatorName("Map")).to.be.false;
        });
    ...
    describe("Dag Category Custom", function() {
        ...
        it("get sorted operators should work", function() {
            ...
            expect(opNames).to.deep.equal(["Custom", "CustomOutput", "Input", "Map", "newname", "testName-1"]);
        });
    });
